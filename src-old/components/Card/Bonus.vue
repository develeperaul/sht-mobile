...
.card-bonus {
  @apply tw-rounded-32 tw-text-white tw-grid tw-grid-cols-2;
  background: linear-gradient(98.74deg, #889eda 16.72%, #e2ecf2 80.14%);
  &__btn {
    @apply tw-bg-geen_btn tw-text-black tw-font-normal tw-w-fit tw-px-[15px];
    font-size: 14px;
    line-height: 18px;
    height: 28px;
    font-weight: 700;
