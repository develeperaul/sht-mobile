import{_ as s}from"./Toolbar-BS_jKQ9P.js";import{Q as a}from"./QPage-IJdRgCnN.js";import{u as r}from"./useTypograf-BoULwCSd.js";import{d as n,z as t,e as w,o as i,w as p,a as e,K as c,O as h}from"./index-Cw5EAXYG.js";import"./ButtonRound-CLlU13CD.js";import"./BaseIcon.vue_vue_type_script_setup_true_lang-BadFC8O-.js";const m=["innerHTML"],_=`
Политика конфиденциальности
        ...
        данных, предпринимаемые ООО «Энджой Тревел» (далее — Оператор). 1.1.
        ...
        может получить о посетителях веб-сайта https://www.sayhello.travel/. 2.
        ...
        сети интернет по сетевому адресу https://www.sayhello.travel/. 2.4.
        ...
        Пользователю веб-сайта https://www.sayhello.travel/. 2.9. Персональные
        ...
        https://www.sayhello.travel/ 2.11. Предоставление персональных данных —
        ...
        данные: фамилия, имя, отчество электронный адрес номера телефонов иные
        сведения, указанные вами при заполнении квиза, заявки на тур или формы
        обратного звонка. Правовые основания: уставные (учредительные) документы
        Оператора ст. 6, 10, 11 ФЗ-152 «О персональных данных» Виды обработки
        ...
        писем на адрес электронной почты 7. УСЛОВИЯ ОБРАБОТКИ ПЕРСОНАЛЬНЫХ
        ...
        уведомление на адрес электронной почты Оператора hello@sayhello.travel с
        ...
        Оператора hello@sayhello.travel с пометкой «Отзыв согласия на обработку
        ...
        Политикой конфиденциальности. Субъект вправе ознакомиться персональных
        данных и/или с указанными документами. Оператор не несет ответственность
        ...
        ИСПОЛЬЗОВАНИЕ ФАЙЛОВ СOOKIES Сайт https://www.sayhello.travel использует
        файлы cookies и аналогичные технологии (в т.ч. Яндекс.Метрика, Roistat,
        VK Pixel). для обеспечения работоспособности сайта, анализа поведения
        пользователей и предоставления персонализированного контента.
        Пользователь вправе отказаться от использования cookies, изменив
        настройки в своем браузере. Продолжая использовать сайт, Пользователь
        выражает согласие на использование файлов cookies. 13. ЗАКЛЮЧИТЕЛЬНЫЕ
        ПОЛОЖЕНИЯ 13.1. Пользователь может получить любые разъяснения по
        интересующим вопросам, касающимся обработки его персональных данных,
        обратившись к Оператору с помощью электронной почты
        hello@sayhello.travel 13.2. В данном документе будут отражены любые
...
`,T=n({__name:"Policy",setup(f){t(!1),t(!1),t(!1);const{typograf:o}=r(()=>null);return(u,y)=>{const l=s;return i(),w(a,{class:"tw-container env-t tw-grid tw-content-between"},{default:p(()=>[e("div",null,[c(l,{class:"tw-mb-5",title:"Политика конфиденциальности"}),e("div",{class:"tw-bg-white tw-rounded-[20px] tw-py-3 tw-px-4 -tw-mx-4 tw-font-medium glass-w",style:{"font-size":"14px","line-height":"18px"},innerHTML:h(o)(_)},null,8,m)])]),_:1})}}});export{T as default};
